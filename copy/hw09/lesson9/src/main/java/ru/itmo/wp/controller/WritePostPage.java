...
public class WritePostPage extends Page {
    ...
    public WritePostPage(UserService userService, TagService tagService, PostFormValidator postFormValidator) {
    ...
    public String writePostPost(@Valid @ModelAttribute("postForm") PostForm postForm,
        ...
        userService.writePost(getUser(httpSession), postForm, tagService);
