...
public class StaticServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for (String currentUri : uriArray) {
            File firstFile = new File("/home/roma/work/itmo/web/hw03/4/wp3/src/main/webapp/static/" + currentUri);
            File secondFile = new File(getServletContext().getRealPath("/static/" + currentUri)) ;
            if (firstFile.isFile()) {
