...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        try {
            ...
            Method before = pageClass.getSuperclass().getDeclaredMethod("before", HttpServletRequest.class, Map.class);
            Method after = pageClass.getSuperclass().getDeclaredMethod("after", HttpServletRequest.class, Map.class);
            ...
            if (cause instanceof RedirectException) {
                ...
                for (Map.Entry<String, String[]> param : request.getParameterMap().entrySet()) {
                    ...
                    if (param.getValue() != null && param.getValue().length == 1 && !key.equals("message")) {
