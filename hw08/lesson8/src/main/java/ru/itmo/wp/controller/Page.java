...
public class Page {
    ...
    private static final String NOTICE_SESSION_KEY = "noticeId";
    private static final String MESSAGE_TYPE_SESSION_KEY = "messageType";
    ...
    void putMessage(HttpSession httpSession, String message) {
        ...
        httpSession.setAttribute(MESSAGE_TYPE_SESSION_KEY, "success");
    }

    void putError(HttpSession httpSession, String message) {
        httpSession.setAttribute(MESSAGE_SESSION_KEY, message);
        httpSession.setAttribute(MESSAGE_TYPE_SESSION_KEY, "error");
    }
}
