...
public class UserService {
    ...
    public void updateDisabled(UserStatusForm userStatusForm) {
        userRepository.updateDisabled(userStatusForm.getId(), userStatusForm.getAction().equals("disable"));
    }

    public boolean validateForm(User user, UserStatusForm userStatusForm) {
        long id = userStatusForm.getId();
